class ForecastWsizesController < ApplicationController
  # GET /forecast_wsizes
  ...
  def create
    ...
    respond_to do |format|
      if @forecast_wsize.save
        format.html { redirect_to @forecast_wsize, notice: 'Forecast wsize was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @forecast_wsize.update_attributes(params[:forecast_wsize])
        format.html { redirect_to @forecast_wsize, notice: 'Forecast wsize was successfully updated.' }
        format.json { head :ok }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to forecast_wsizes_url }
      format.json { head :ok }
    end
  end
end
