...
describe "up_sizes/edit.html.erb" do
  before(:each) do
    @up_size = assign(:up_size, stub_model(UpSize,
      :chima_id => 1,
      :front_length => "9.99",
      :back_length => "9.99",
      :chest => "9.99",
  ...
  it "renders the edit up_size form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => up_sizes_path(@up_size), :method => "post" do
