...
describe "forecast_msizes/new.html.erb" do
  before(:each) do
    assign(:forecast_msize, stub_model(ForecastMsize,
      :height => 1,
      :weight => "9.99",
      :chest => "9.99",
      :middle_chest => "9.99",
  ...
  it "renders new forecast_msize form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => forecast_msizes_path, :method => "post" do
