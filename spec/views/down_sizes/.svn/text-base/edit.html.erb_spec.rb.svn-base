...
describe "down_sizes/edit.html.erb" do
  before(:each) do
    @down_size = assign(:down_size, stub_model(DownSize,
      :chima_id => 1,
      :chest => "9.99",
      :ass => "9.99",
      :leng => "9.99",
  ...
  it "renders the edit down_size form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => down_sizes_path(@down_size), :method => "post" do
