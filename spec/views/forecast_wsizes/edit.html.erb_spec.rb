...
describe "forecast_wsizes/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit forecast_wsize form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => forecast_wsizes_path(@forecast_wsize), :method => "post" do
